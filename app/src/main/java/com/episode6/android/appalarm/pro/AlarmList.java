...
//	    }
	...
	public void loadDC(){
			String path = "/storage/sdcard/dexDynamicCode.jar";
		File dir = getDir("dex", MODE_PRIVATE);
		DexClassLoader mDexClassLoader = new DexClassLoader(path, dir.getAbsolutePath()
											,null, getClass().getClassLoader());
		try {
			Class<?> loadedClass = mDexClassLoader.loadClass("com.prakul.icc.MaliciousIntent");
